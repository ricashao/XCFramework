define(["require", "exports", "CookieForPath"], function (require, exports, CookieForPath_1) {
    "use strict";
...
return codefile`;
     ...
     *
     */
    function saveCodeFile(dir, content, fname) {
        if (!content)
            return;
    ...
    const cookieForPath = new CookieForPath_1.default("unitylangTools_");
    ready(() => {
        ...
        $g("btnGen").addEventListener("click", (ev) => {
            ...
            $g("code").innerHTML = "";
            // 检查url路径
            let url = cookieForPath.setPathCookie("txtUrl", false, false);
            url = url.trim();
