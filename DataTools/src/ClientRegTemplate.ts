...
export default class ClientRegTemplate {
    ...
    */
    public addToFile(file: string, key: string, pak: string, hasExtra: boolean) {
     ...
     * @returns (description)
     */
    private addContent(key: string, interfaceDic: Map<string, string>, valueDic: Map<string, string>, regDic: Map<string, any[]>, pak: string, extlist: string[], hasExtra: boolean) {
        let added = false;
